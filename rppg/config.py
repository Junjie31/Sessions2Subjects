...
# RhythmMamba_scan specific settings
_C.MODEL.GRID_SIZE = 3
_C.MODEL.REGION_DEPTH = 4
_C.MODEL.SCAN_ORDER = 'pool_time'
_C.MODEL.SCAN_MODE = 'uni'
_C.MODEL.DYNAMIC_MODE = 'fixed'  # "fixed" | "quality_sort" | "moe" | "full"
_C.MODEL.FREQ_WEIGHT = 0.5  # for RhythmMamba_fusion_freq: weight of freq features
_C.MODEL.MODULATION_MODE = 'scalar'  # scan modulation: scalar|strong|mlp|b_gate|delta_b|exp|sigmoid|per_dim
_C.MODEL.QUALITY_SCALE_INIT = 0.1  # initial quality scale for delta modulation
_C.MODEL.QUALITY_MODE = 'fusion'  # quality signal: fusion|freq|temporal_grad|learned|hybrid
_C.MODEL.OSC_LEARN_OMEGA = True   # osc/osc_real: learn omega or use fixed HR-band frequencies
